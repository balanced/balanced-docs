...
class Spec(dict):
    ...
    def match_form(self, name):
        ...
        required = generate_key_set(self, reqs[0], resource)
        ...
        for r in reqs:
            keys = generate_key_set(self, r, resource)
            ...
            nullable_keys = nullable_key_set(self, r, resource)
        ...
        for key_set in [required, all_keys, nullable]:
            remove_ignored_keys(self, key_set)
